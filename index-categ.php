    ...
    <div class="body">
        ...
        <div class="container d-flex">
            ...
            <div class="d-flex flex-column flex-lg-row">
                ...
                $count = mysqli_num_rows($getPostResult);
                            ...
                            <div aria-label="page navigation ">
                                <ul class="pagination">
                                    ...
                                    <li class="page-item   <?php
                                        ...
                                        <a class="page-link"
                                            href="<?php echo "index-categ.php?categ=$categoryName&amp;page=$prevPage" ?>"
                                            aria-label=" Previous">
                                    ...
                                    <li class="page-item"><a <?php if ($page == $i) echo 'style="color:#454545;"'; ?>
                                            class="page-link "
                                            href="<?php echo "index-categ.php?categ=$categoryName&amp;page=$i" ?>"><?php echo $i; ?></a>
                                    </li>
                                    ...
                                    <li class="page-item <?php
                                        ...
                                        <a class="page-link"
                                            href=" <?php echo "index-categ.php?categ=$categoryName&amp;page=$nextPage" ?>"
                                            aria-label="
                                            Next">
