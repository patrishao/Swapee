         ...
         <div class="title2 ">
             ...
             <div class="container d-flex justify-content-center align-content-center align-items-center ">
                 ...
                 <div class="container animate__animated  animate__fadeInDown">
                     <h1 class="ps-lg-5 pe-lg-5 p-2 pb-lg-0 ">You've searched for.. </h1>

                     <p class="ps-lg-5 pe-lg-5 pt-lg-0 p-2 "><?php echo $searchedWord ?></p>
                 </div>


                 <img src="images/home/illus_result.png" alt=""
                     class="animate__animated  animate__fadeInDown title-img">
         ...
         <div class="container d-flex">
             ...
             <div class="d-flex flex-column flex-lg-row">
                         ...
                         <div class="categories">
                             ...
                             <div class="dropdown">
                                 ...
                                 <ul class="dropdown-menu  " aria-labelledby="dropdownMenuLink">
                                     ...
                                     <li> <a
                                             href="search.php?search=<?php echo $searchedWord ?>&sort=offered#item">Offered</a>
                                     </li>
                                     <li>

                                         <a
                                             href="search.php?search=<?php echo $searchedWord ?>&sort=wanted#item">Wanted</a>
                                     </li>
                                 </ul>
                             </div>
                     ...
                     <div class="lg-dropdown d-md-block d-none ">
                         ...
                         <div class="aside  ">
                             ...
                             <div class="categories mt-5">
                                 <h5>Sort by</h5>
                                 <a href="search.php?search=<?php echo $searchedWord ?>&sort=offered#item">Offered</a>
                                 <a href="search.php?search=<?php echo $searchedWord ?>&sort=wanted#item">Wanted</a>
                             </div>
                 ...
                 <?php require_once('private/includes/connection.php');
                    ...
                    if (empty($sort)) {
                        $getPostbyCategoryQuery = "SELECT * FROM posts WHERE title LIKE '%$searchedWord%' OR description LIKE '%$searchedWord%'  OR category LIKE '%$searchedWord%'  ORDER BY isFeatured DESC, post_id DESC  LIMIT $page_1,9";
                        $getTotalPostbyCategoryQuery = "SELECT * FROM posts WHERE title LIKE '%$searchedWord%' OR description LIKE '%$searchedWord%'  OR category LIKE '%$searchedWord%'";
                    } else {
                        $getPostbyCategoryQuery = "SELECT * FROM posts WHERE status = '$sort' AND title LIKE '%$searchedWord%' OR description LIKE '%$searchedWord%'  OR category LIKE '%$searchedWord%' ORDER BY isFeatured DESC, post_id DESC  LIMIT $page_1,9";
                        $getTotalPostbyCategoryQuery = "SELECT * FROM posts WHERE title LIKE '%$searchedWord%' OR description LIKE '%$searchedWord%' OR category LIKE '%$searchedWord%' AND status = '$sort'  ";
                    }
